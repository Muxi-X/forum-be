...
func Load(g *gin.Engine, mw ...gin.HandlerFunc) *gin.Engine {
	...
	postRouter.Use(normalRequired)
	{
		...
		postRouter.PUT("", middleware.Audit(auditApi), postApi.UpdateInfo)
	...
	{
		sipScoreRouter.POST("", middleware.Audit(auditApi), sipScoreApi.CreateSipScore)
		sipScoreRouter.PUT("", middleware.Audit(auditApi), sipScoreApi.UpdateSipScore)
